...
const COPY = {
  it: {
    hero: {
      ...
      body: 'Ogni progetto qui sotto è un’azienda vera: il problema con cui è arrivata, cosa abbiamo costruito e cosa è cambiato dopo. Niente slide, niente mockup.',
      filtersLabel: 'Filtra',
      all: 'Tutti',
  ...
  en: {
    hero: {
      ...
      body: 'Every project below is a real company: the problem they came with, what we built, and what changed afterwards. No slides, no mockups.',
      filtersLabel: 'Filter',
      all: 'All',
